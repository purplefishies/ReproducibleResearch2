...
For instance, a typical encounter would be to first filter the events that matched "Hail", and then reduce that set by excluding events that matched tornado and hurricane. 
