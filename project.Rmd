...
In this analysis, I investigated ways to assess which weather
...
of 1950 and 2011, provide the most harm to both Human life and to two
key economic metrics. The assumptions for this analysis will be built up on
...
I then needed to get my data into a format that avoided redundancy and
...
<!-- I calculated each type of event as follows -->
```{r,echo=FALSE}
length(ddat$F)
```
...
top 2 weather related disasters that were considered leaders of fatalities,
injuries, property and crop damage.  In addition, I created another 
