...
<!-- asdpp  -->
```{r,echo=TRUE}
topinjure  <- all_data %>% top_n(1, wt=ave_injuries )
topdmg     <- all_data %>% top_n(1, wt=ave_propdmg )
topcrop    <- all_data %>% top_n(1, wt=ave_cropdmg )
topfatal   <- all_data %>% top_n(1, wt=ave_fatalities)
