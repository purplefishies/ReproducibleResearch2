...
p3 <- ggplot( all_top, aes(x=EVTYPE,y=tot_injuries,fill=EVTYPE)) + geom_bar(stat="identity",position='dodge')
p4 <- ggplot( all_top, aes(x=EVTYPE,y=tot_injuries,fill=EVTYPE)) + geom_bar(stat="identity",position='dodge')
